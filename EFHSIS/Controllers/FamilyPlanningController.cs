...
namespace EFHSIS.Controllers
{
    ...
    public class FamilyPlanningController : Controller
    {
        ...
        public FamilyPlanningController(ILogger<FamilyPlanningController> logger, ApplicationDbContext context)
        {
            _logger = logger;
            _context = context;
        }
        ...
        public IActionResult FamilyHome()
        {
            ...
            GraphFunc("FamilyPlanningGraph", Convert.ToDateTime(firstDay), Convert.ToDateTime(lastDay));
            return View();
        }
        ...
        public void GraphFunc(string stored_func, DateTime firstDay, DateTime lastDay)
        {
            ...
            var tuberculosis = _context.FamilyPlanning.FromSqlRaw($"EXEC EFHSIS.dbo.{stored_func} @date_start = N'{firstDay}',@date_end = N'{lastDay}',@prov_code = N'{province}';");
