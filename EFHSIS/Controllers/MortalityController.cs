...
namespace EFHSIS.Controllers
{
    ...
    public class MortalityController : Controller
    {
        ...
        public IActionResult MortalityHome()
        {
            ...
            GraphFunc("MortalityGraph", Convert.ToDateTime(firstDay), Convert.ToDateTime(lastDay));
            return View();
        }
        [HttpPost]
        ...
        public void GraphFunc(string stored_func, DateTime firstDay, DateTime lastDay)
        {
            ...
            var tuberculosis = _context.Mortality.FromSqlRaw($"EXEC EFHSIS.dbo.{stored_func} @date_start = N'{firstDay}',@date_end = N'{lastDay}',@prov_code = N'{province}';");
