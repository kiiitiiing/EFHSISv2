...
namespace EFHSIS.Controllers
{
    ...
    public class MortBhsController : Controller
    {
        ...
        public IActionResult MortBhsHome()
        {
            ...
            GraphFunc("MortBhsGraph", Convert.ToDateTime(firstDay), Convert.ToDateTime(lastDay));
            return View();
        }
        [HttpPost]
        ...
        {
            var tuberculosis = _context.MortBhs.FromSqlRaw($"EXEC EFHSIS.dbo.{stored_func} @date_start = N'{firstDay}',@date_end = N'{lastDay}',@prov_code = N'CEBU';");
