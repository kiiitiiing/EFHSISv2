...
namespace EFHSIS.Controllers
{
    ...
    public class MaternalCareController : Controller
    {
        ...
        public IActionResult MaternalHome()
        {
            ...
            GraphFunc("MaternalCareGraph", Convert.ToDateTime(firstDay), Convert.ToDateTime(lastDay));
            return View();
        }
        [HttpPost]
        ...
        public void GraphFunc(string stored_func, DateTime firstDay, DateTime lastDay)
        {
            ...
            var tuberculosis = _context.MaternalCare.FromSqlRaw($"EXEC EFHSIS.dbo.{stored_func} @date_start = N'{firstDay}',@date_end = N'{lastDay}',@prov_code = N'{province}';");
