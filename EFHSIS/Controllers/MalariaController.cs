...
namespace EFHSIS.Controllers
{
    ...
    {
        private readonly ILogger<MalariaController> _logger;
        private readonly ApplicationDbContext _context;

        public MalariaController(ILogger<MalariaController> logger, ApplicationDbContext context)
        {
            _logger = logger;
            _context = context;
        }
        ...
        public IActionResult MalariaHome()
        {
            ...
            GraphFunc("MalariaGraph", Convert.ToDateTime(firstDay), Convert.ToDateTime(lastDay));
            return View();
        }
        [HttpPost]
        ...
        public void GraphFunc(string stored_func, DateTime firstDay, DateTime lastDay)
        {
            ...
            var tuberculosis = _context.Malaria.FromSqlRaw($"EXEC EFHSIS.dbo.{stored_func} @date_start = N'{firstDay}',@date_end = N'{lastDay}',@prov_code = N'{province}';");
