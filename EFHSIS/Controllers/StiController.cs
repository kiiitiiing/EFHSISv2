...
namespace EFHSIS.Controllers
{
    ...
    public class StiController : Controller
    {
        ...
        public StiController(ILogger<StiController> logger, ApplicationDbContext context)
        {
            _logger = logger;
            _context = context;
        }
        ...
        public IActionResult StiHome()
        {
            ...
            GraphFunc("StiGraph", Convert.ToDateTime(firstDay), Convert.ToDateTime(lastDay));
            return View();
        }
        [HttpPost]
        ...
        public void GraphFunc(string stored_func, DateTime firstDay, DateTime lastDay)
        {
            ...
            var tuberculosis = _context.Sti.FromSqlRaw($"EXEC EFHSIS.dbo.{stored_func} @date_start = N'{firstDay}',@date_end = N'{lastDay}',@prov_code = N'{province}';");
