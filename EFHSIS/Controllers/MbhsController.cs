...
namespace EFHSIS.Controllers
{
    ...
    {
        private readonly ILogger<MbhsController> _logger;
        private readonly ApplicationDbContext _context;

        public MbhsController(ILogger<MbhsController> logger, ApplicationDbContext context)
        {
            _logger = logger;
            _context = context;
        }
        ...
        public IActionResult MbhsHome()
        {
            ...
            GraphFunc("M2bhsGraph", Convert.ToDateTime(firstDay), Convert.ToDateTime(lastDay));
            return View();
        }
        [HttpPost]
        ...
        public void GraphFunc(string stored_func, DateTime firstDay, DateTime lastDay)
        {
            ...
            var tuberculosis = _context.M2Bhs.FromSqlRaw($"EXEC EFHSIS.dbo.{stored_func} @date_start = N'{firstDay}',@date_end = N'{lastDay}',@prov_code = N'{province}';");
