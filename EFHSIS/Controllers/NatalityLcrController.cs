...
namespace EFHSIS.Controllers
{
    ...
    {
        private readonly ILogger<NatalityLcrController> _logger;
        private readonly ApplicationDbContext _context;

        public NatalityLcrController(ILogger<NatalityLcrController> logger, ApplicationDbContext context)
        {
            _logger = logger;
            _context = context;
        }
        ...
        public IActionResult NatalityLcrHome()
        {
            ...
            GraphFunc("NatalityLcrGraph", Convert.ToDateTime(firstDay), Convert.ToDateTime(lastDay));
            return View();
        }
        [HttpPost]
        ...
        public void GraphFunc(string stored_func, DateTime firstDay, DateTime lastDay)
        {
            ...
            var tuberculosis = _context.NatalityLcr.FromSqlRaw($"EXEC EFHSIS.dbo.{stored_func} @date_start = N'{firstDay}',@date_end = N'{lastDay}',@prov_code = N'{province}';");
